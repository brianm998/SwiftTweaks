...
public enum TweakDefaultData {
	...
	case integer(defaultValue: Int, min: Int?, max: Int?, stepSize: Int?, editStyle: NumericEditStyle?)
	case int8(defaultValue: Int8, min: Int8?, max: Int8?, stepSize: Int8?, editStyle: NumericEditStyle?)
	case int16(defaultValue: Int16, min: Int16?, max: Int16?, stepSize: Int16?, editStyle: NumericEditStyle?)
	case int32(defaultValue: Int32, min: Int32?, max: Int32?, stepSize: Int32?, editStyle: NumericEditStyle?)
	case int64(defaultValue: Int64, min: Int64?, max: Int64?, stepSize: Int64?, editStyle: NumericEditStyle?)
	case uInt8(defaultValue: UInt8, min: UInt8?, max: UInt8?, stepSize: UInt8?, editStyle: NumericEditStyle?)
	case uInt16(defaultValue: UInt16, min: UInt16?, max: UInt16?, stepSize: UInt16?, editStyle: NumericEditStyle?)
	case uInt32(defaultValue: UInt32, min: UInt32?, max: UInt32?, stepSize: UInt32?, editStyle: NumericEditStyle?)
	case uInt64(defaultValue: UInt64, min: UInt64?, max: UInt64?, stepSize: UInt64?, editStyle: NumericEditStyle?)
	case float(defaultValue: CGFloat, min: CGFloat?, max: CGFloat?, stepSize: CGFloat?, editStyle: NumericEditStyle?)
	case doubleTweak(defaultValue: Double, min: Double?, max: Double?, stepSize: Double?, editStyle: NumericEditStyle?)
